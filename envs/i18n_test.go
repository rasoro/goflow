...
func TestGetTranslation(t *testing.T) {
	tests := []struct {
		...
		{envs.NewLocale(envs.Language("eng"), envs.Country("US")), "Sun", "Sunday", "Jan", "January"},
		{envs.NewLocale(envs.Language("eng"), envs.Country("GB")), "Sun", "Sunday", "Jan", "January"},
		{envs.NewLocale(envs.Language("eng"), envs.NilCountry), "Sun", "Sunday", "Jan", "January"},
		...
		{envs.NewLocale(envs.Language("zho"), envs.Country("CN")), "日", "星期日", "1月", "一月"},
		{envs.NewLocale(envs.Language("zho"), envs.Country("HK")), "日", "星期日", "1月", "一月"},
		{envs.NewLocale(envs.Language("zho"), envs.Country("SG")), "日", "星期日", "一月", "一月"},
		{envs.NewLocale(envs.Language("zho"), envs.Country("TW")), "日", "週日", " 1月", "一月"},
		{envs.NewLocale(envs.Language("zho"), envs.NilCountry), "日", "星期日", "1月", "一月"}, // backs down to first zh translation
	}
